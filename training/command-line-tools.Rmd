...
If you are outside the University of Sheffield We are not able to offer a great deal of support for analysis on your institutes' computing environment. In brief, the `singularity` tool will need to be installed, which can then be used to convert the docker container into a correspoding singularity file. 
