...
p1 <- EnhancedVolcano(data.frame(res_macrophage_IFNg_vs_naive), lab = res_macrophage_IFNg_vs_naive$SYMBOL, x = "log2FoldChange", y = "padj", caption = "Differential Expression of IFNg vs Naive")
ggsave("example_volcano.jpeg", width = 1800, height=1800,units="px")
